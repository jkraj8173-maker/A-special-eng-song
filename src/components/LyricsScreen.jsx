            ...
            <AnimatePresence mode="wait">
                {isAnimating && currentLyricIndex < lyrics.length && (
                    <motion.div
                        ...
                        className="text-center relative lyric-glow"
                    >
                        <Sparkles count={6} />
                        {currentLyricIndex === 0 ? (
                            <div className="flex flex-wrap justify-center items-center gap-x-3">
                                <TextAnimate
                                    ...
                                    duration={2.4}
                                    animation="blurInUp"
                                    className="text-3xl md:text-5xl lg:text-6xl text-foreground purple-shine"
                                >
                                    When
                                </TextAnimate>
                                ...
                                <TextAnimate
                                    ...
                                    delay={1.8}
                                    animation="blurInUp"
                                    className="text-3xl md:text-5xl lg:text-6xl text-foreground purple-shine text-balance leading-normal"
                                >
